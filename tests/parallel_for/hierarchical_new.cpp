...
int test_main(int argc, char *argv[]) {
  ...
  generic_par_for_wg<2, class par_2d_square>({120, 120}, {40, 40});
  generic_par_for_wg<2, class par_2d_rect>({120, 60}, {40, 20});
  generic_par_for_wg<3, class par_3d_square>({100, 100, 100}, {20, 20, 20});
  generic_par_for_wg<3, class par_3d_rect>({150, 200, 150}, {15, 20, 15});
